...
<html>
    ...
    <body>
        ...
        <table>
            ...
            <?php
            include_once 'DataBase.php';
            $result = mysqli_query($conn,"SELECT m.Code_a_barre,t.Libelle_type,m.Marque,d.Libelle_division,s.Libelle_service,m.Emplacement,u.Nom,m.Date,e.Libelle_etat,m.Remarque,t.Code_Type,m.adresse,m.taille,m.pointure
