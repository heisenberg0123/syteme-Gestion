...
<body>
    <div style="width:1840px;height:950px;border:1px solid black;" >
        ...
        <li ><img src="add.png"><a href="ajout_client.php" >Ajout un client</a></li>
            <li><img src="modif.jpg"/><a href="modif_client.php">Modifie un client</a></li>
            <li><img src="supprimer.jpg"/><a href="supprim_client.php">Supprime un client</a></li>
