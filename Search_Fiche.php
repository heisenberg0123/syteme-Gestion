...
<body>
  ...
  <div class="desc">Affichage</div></a>
        ...
        <form action="Fiche_Equipement.php" method="post" >
        ...
        <div class="form-floating form" >
            ...
            <label for="search">Code a barre</label>
    ...
    <div style="border-top:1px solid black;height:88px;transform:translate(0px,600px);background-color:yellow;">
