...
<body>
    <div style="width:1840px;height:950px;border:1px solid black;" >
        ...
        <ul style="width:452px;">
            <li ><img src="add.png"><a href="ajout_form.php" >Ajout une formation</a></li>
            <li><img src="modif.jpg"/><a href="modif_form.php">Modifie une formation</a></li>
            <li><img src="supprimer.jpg"/><a href="supprim_form.php">Supprime une formation</a></li>
        </ul>
    </div>
